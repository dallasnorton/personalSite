  ...
  constructor(props) {
    ...
    this.socialMediaSites = socialMediaData.map((site, index) => {
      return <div key={index} className="social-media-wrapper">
        <svg className="social-media-icons" viewBox="0 0 24 24"><path d={site.icon}></path></svg>
